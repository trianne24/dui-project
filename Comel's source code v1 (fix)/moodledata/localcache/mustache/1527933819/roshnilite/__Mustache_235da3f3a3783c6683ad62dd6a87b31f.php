...
class __Mustache_235da3f3a3783c6683ad62dd6a87b31f extends Mustache_Template
{
...
';
        ...
        if ($parent = $this->mustache->loadPartial('block_myoverview/event-list-group')) {
            $context->pushBlockContext(array(
                ...
                'eventlistitems' => array($this, 'blockC41302f9ec5950c2e306bb60aab730de'),
            ));
        ...
        $buffer .= '
';
        $buffer .= $indent . '        <div class="text-xs-center text-center m-b-1">
';
...
';
        $buffer .= $indent . '    </div>
';
        $buffer .= $indent . '    <div class="hidden text-xs-center text-center m-y-3" data-region="empty-message">
';
        $buffer .= $indent . '        <img class="empty-placeholder-image-sm"
';
        $buffer .= $indent . '             src="';
...
';
        ...
        // 'str' section
        $value = $context->find('str');
        $buffer .= $this->section15e6fc3f73aae379f9cb23d5072b8800($context, $indent, $value);
        $buffer .= '">
';
        $buffer .= $indent . '            ';
        // 'str' section
        $value = $context->find('str');
        $buffer .= $this->section5f671f0d817df3fa4049ef34a34b0e8c($context, $indent, $value);
        $buffer .= '
';
        $buffer .= $indent . '        </a>
';
...
';
    ...
    private function section15e6fc3f73aae379f9cb23d5072b8800(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    
        if (!is_string($value) && is_callable($value)) {
            $source = ' viewcoursename, block_myoverview, {{{fullnamedisplay}}} ';
            $result = call_user_func($value, $source, $this->lambdaHelper);
            if (strpos($result, '{{') === false) {
                $buffer .= $result;
            } else {
            ...
            foreach ($values as $value) {
                ...
                $buffer .= ' viewcoursename, block_myoverview, ';
    ...
    private function section5f671f0d817df3fa4049ef34a34b0e8c(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    
        if (!is_string($value) && is_callable($value)) {
            $source = ' viewcourse, block_myoverview ';
            $result = call_user_func($value, $source, $this->lambdaHelper);
            if (strpos($result, '{{') === false) {
                $buffer .= $result;
            } else {
            ...
            foreach ($values as $value) {
                ...
                $buffer .= ' viewcourse, block_myoverview ';
                $context->pop();
            }
        }
...
';
    ...
    public function blockC41302f9ec5950c2e306bb60aab730de($context)
    {
        $indent = $buffer = '';
        if ($partial = $this->mustache->loadPartial('block_myoverview/course-event-list-items')) {
            $buffer .= $partial->renderInternal($context, $indent . '                ');
        }
