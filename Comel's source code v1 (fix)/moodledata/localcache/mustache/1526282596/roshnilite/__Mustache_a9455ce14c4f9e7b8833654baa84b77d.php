...
class __Mustache_a9455ce14c4f9e7b8833654baa84b77d extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->sectionCd76f9873d343c3176d85d39ba08066f($context, $indent, $value);
        $buffer .= $indent . '</div>
';
        $buffer .= $indent . '
';
    ...
    private function section42f3d277cb260b2b2eb57f8cec7a8222(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        ...
        ';
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $indent . '            <span class="pathok">&#x2714;</span>
';
                $context->pop();
            }
        }
    ...
    private function sectionCd76f9873d343c3176d85d39ba08066f(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    ...
    ';
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $this->section42f3d277cb260b2b2eb57f8cec7a8222($context, $indent, $value);
                // 'valid' inverted section
                $value = $context->find('valid');
                if (empty($value)) {
                    
                    $buffer .= $indent . '            <span class="patherror">&#x2718;</span>
';
                }
                $context->pop();
            }
