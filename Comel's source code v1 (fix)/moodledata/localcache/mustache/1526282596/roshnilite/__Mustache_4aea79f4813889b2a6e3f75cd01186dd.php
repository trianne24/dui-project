...
class __Mustache_4aea79f4813889b2a6e3f75cd01186dd extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->sectionB291375857e23532eaaa96ba985c93f6($context, $indent, $value);
        $buffer .= $indent . '    </tbody>
';
        $buffer .= $indent . '</table>
';
...
';
        ...
        $buffer .= $this->section32a8dd5327ce4b1fdb39fe70cd06606d($context, $indent, $value);
        $buffer .= $indent . '
';
        // 'js' section
...
';
    ...
    private function sectionEcb3c8237bc9be2b75a9681bdd3db3ab(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function sectionB291375857e23532eaaa96ba985c93f6(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                ...
                $buffer .= $this->sectionEcb3c8237bc9be2b75a9681bdd3db3ab($context, $indent, $value);
...
';
    ...
    private function section32a8dd5327ce4b1fdb39fe70cd06606d(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
