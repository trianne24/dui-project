...
class __Mustache_e3c645d9eb8386af90a3683aea797b39 extends Mustache_Template
{
...
';
        ...
        $buffer .= '">
';
        $buffer .= $indent . '            <a class="nav-link" href="#myoverview_timeline_view" role="tab" data-toggle="tab" data-tabname="timeline">
';
        $buffer .= $indent . '                ';
        // 'str' section
...
';
        ...
        $buffer .= '">
';
        $buffer .= $indent . '            <a class="nav-link" href="#myoverview_courses_view" role="tab" data-toggle="tab" data-tabname="courses">
';
        $buffer .= $indent . '                ';
        // 'str' section
        $value = $context->find('str');
